...
{
    BOOL isNeedCCMenuItemLabelDealloc_;
}
...
{
    BOOL isNeedCCMenuItemAtlasFontDealloc_;
}
...
{
    BOOL isNeedCCMenuItemFontDealloc_;
}
...
{
    BOOL isNeedCCMenuItemSpriteDealloc_;
}
...
{
    BOOL isNeedCCMenuItemImageDealloc_;
}
...
{
    BOOL isNeedCCMenuItemToggleDealloc_;
}
